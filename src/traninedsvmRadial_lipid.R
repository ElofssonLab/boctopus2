...
load("svmtrain42_lipidfacing.Rdata")
print("Start")
#tempResult <- predict(svmtrain36_lipidfacing, testX, decision.values = TRUE, probability = TRUE)
tempResult <- predict(svmtrain42_lipidfacing, testX, decision.values = TRUE, probability = TRUE)
